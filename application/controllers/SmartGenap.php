...
class SmartGenap extends CI_Controller {
...
'H2'     => $this->Smart_model->H_Genap($mhs),
//'H3'     => $this->Smart_model->H3($mhs),
'H4'     => $this->Smart_model->H_Genap($mhs),
'H5'     => $this->Smart_model->H5($mhs),
'H6'     => $this->Smart_model->H6($mhs),
'H7'     => $this->Smart_model->H7($mhs),
'H8'     => $this->Smart_model->H8($mhs),
	'content'           => 'expertkrs/expertrule_Genap',
'judul'             => 'Lembar Entry KRS Semester Genap',
...
'sem_4'             => $this->Entry_model->join_mk_semester($mhs),

'semester_sekarang' => $this->db->get('semester_sekarang')->row(),
'mengulang_semester2' => $this->Smart_model->valid_semester2($respon),
'mengulang_semester4' => $this->Smart_model->valid_semester4($respon),
'mengulang_semester6' => $this->Smart_model->valid_semester6($respon),
'mengulang_semester8' => $this->Smart_model->valid_semester8($respon),

'rekomendSC'  => $this->Smart_model->rekomend("SC"),
'rekomendPPK' => $this->Smart_model->rekomend("PPK"),
'rekomendJCM' => $this->Smart_model->rekomend("JCM"),
...
if (($sum_sks_rb1->totalsksRB1+$mk_t->sks)<=24) {
	...
	redirect(site_url('SmartGenap/index/'.$redirect->id_pertanyaan));
		// batas pagi
...
public function simpan_ke_entry_temp4()
{
...
public function simpan_ke_entry_temp6()
{
...
public function simpan_ke_entry_temp8()
{
...
public function simpanP6_H2()
{
  ...
  $this->db->insert('entry', $result_replace);
	...
	$this->Smart_model->hapus_entry_temp();
 ...
 <strong>Berhasil !</strong> KRS Anda Berhasil Tersimpan !.
								 ...
								 redirect(site_url('SmartGenap/index'));
...
public function hapus_entry_tempData()
{
$seg3= $this->uri->segment(3);
$seg4= $this->uri->segment(4);
$redirect = $this->db->query('select * from pertanyaan where id_pertanyaan="'.$seg4.'"')->row();
...
$del = $this->Smart_model->hapus_entry_temp();
