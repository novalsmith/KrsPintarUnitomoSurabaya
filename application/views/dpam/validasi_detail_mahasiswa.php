...
<a href="#" data-toggle="collapse" data-target="#demo" class="btn btn-small btn-primary pull-right"> 
<p class="glyphicon glyphicon-dashboard"></p>
Lihat History Matakuliah</a>
...
<?php 
$sebelumnya = $this->Entry_model->nilai_sebelumnya($this->uri->segment(3));
 ?>
<!--lihat semua nilai yang sudah di kontrak pada semester sebelumnya-->
...
<li class=""><a class="label label-primary" data-toggle="tab" href="#rekomppk"> Pindah ke PPK</a></li>

<li class=""><a class="label label-primary" data-toggle="tab" href="#rekomsc"> Pindah ke SC </a></li>
...
<li class=""><a class="label label-primary" data-toggle="tab" href="#rekomsc"> Pindah ke SC </a></li>
<li class=""><a class="label label-primary" data-toggle="tab" href="#jcmrekom"> Pindah ke JCM </a>
</li>
...
{
?>
<li class=""><a class="label label-primary" data-toggle="tab" href="#jcmrekom_6">7 JCM</a></li>
...
<li class=""><a class="label label-primary" data-toggle="tab" href="#ppkrekom_6">7 PPK</a></li>
...
if ($rek_jcm->num_rows() <=0) {

  $data =$this->db->query('SELECT * from nilai join bidangminat_bersyarat bb on bb.id_mk = nilai.id_mk where nilai.id_mahasiswa=7 and bb.id_minat=3 and nilai.akhir < 56 ');
...
if ($data->num_rows()>0) {
 ?>
<li class=""><a class="label label-info" data-toggle="tab" href="#bacajcm"> Baca JCM ini</a></li>
<?php }
else
  {
   ?>
<li class=""><a class="label label-default" 
data-toggle="tab" href="#jcmrekom7">  (7) JCM Rekomendasi</a></li>
...
if($rek_ppk->num_rows() <=0)
{

$data =$this->db->query('SELECT * from nilai join bidangminat_bersyarat bb 
  on bb.id_mk = nilai.id_mk 
  where nilai.id_mahasiswa=7 
  and bb.id_minat=2 
  and nilai.akhir < 56 ');
...
if ($data->num_rows()>0) {
 ?>
<li class=""><a class="label label-info" data-toggle="tab" href="#bacappk"> Baca PPK ini </a></li>
<?php }else{ ?>
<li class=""><a class="label label-default" data-toggle="tab" href="#rekomppk7">  (7) PPK Rekomendasi</a></li>
<?php }?>
...
{ ?>
 ...
 <li class=""><a class="label label-default" data-toggle="tab" href="#rekomsc">(7) SC Rekomendasi</a></li>
...
?>
    ...
    <?php
     ...
     echo anchor(site_url('validasi/simpan_entry/'.$keys->id_mk.
     '/'.$this->uri->segment(3)),'Program',
...
echo anchor(site_url('validasi/delete/'.$key->id_entry.'/'.$this->uri->segment(3)),'Delete <p class="glyphicon glyphicon-trash"   ',$data); 
 ?>
